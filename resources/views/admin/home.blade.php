...
<div class="ks-column ks-page">
        <div class="ks-page-header">
            <section class="ks-title-and-subtitle">
                ...
                <button class="btn btn-outline-secondary ks-light ks-no-text ks-tabbed-sidebar-navigation-block-toggle" data-block-toggle=".ks-dashboard-tabbed-sidebar-sidebar">
                                        ...
                                        <div class="ks-tabbed-sidebar-favourites">
                                            ...
                                            <div class="ks-tabbed-sidebar-favourites-items ks-scrollable" data-auto-height>
                                                <a href="#" class="ks-tabbed-sidebar-favourite-item">
                                                    ...
                                                    <button class="btn btn-outline-primary ks-light ks-no-text ks-remove">
