            ...
            <div class="ks-page-content-body ks-projects-dashboard-page">
                <div class="ks-header">
                    <div class="ks-project">
                        ...
                        <span class="ks-name">Awesome project</span>
                    </div>
                    <div class="ks-extras">
                                ...
                                <div class="card ks-panel">
                                    ...
                                    <div class="card-block">
                                        <div class="ks-text-block">
                                            ...
                                            <p class="ks-text">Yandex is a Russian multinational technology company specializing in Internet-related services and products.</p>
                                        </div>
                                        <div class="ks-text-block">
